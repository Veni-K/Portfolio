...
const Projects = () => {
  const projectList = [
    ...
    {
      title: "WebTenderScraper",
      image:scrape,
      description: "A web based general-purpose tender Scraper that extracts key tender details from provided url.",
      github : 'https://github.com/Veni-K/WebTenderScraper.git'
    },
    {
      title: 'Alumni Hub',
      image: alumni,
